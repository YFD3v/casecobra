...
const STEPS = [
  {
    ...
    descripton: "Escolha uma imagem para sua capa",
    url: "/upload",
  },
  {
    name: "Passo 2: Customize o design",
    descripton: "Faça sua capa única",
    url: "/design",
  },
  {
    name: "Passo 3: Resumo",
    descripton: "Veja o resultado final",
    url: "/preview",
  },
];
...
const Steps = () => {
  ...
  return (
    <ol className="rounded-mg bg-white lg:flex lg:rounded-none lg:border-1 lg:border-r lg:border-gray-200">
